    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 3,
          name: "Flutter",
          imageUrl: "https://www.wedigtech.com/img/flutter-logo.png",
          status: "Beginner",
        },
        {
          id: 4,
        ...
        },
        {
          ...
          name: "Dart",
          imageUrl:
            "https://www.christianfindlay.com/assets/images/blog/dart/dart.png",
          status: "Beginner",
        },
        {
          id: 6,
      ...
      socialLinks: [
        {
          id: 1,
          name: "Instagram",
          url: "https://www.instagram.com/adennwild",
          imageUrl: "https://cdn-icons-png.flaticon.com/512/174/174855.png",
        },
        {
          id: 2,
          name: "LinkedIn",
          url: "https://www.linkedin.com/in/aden-wildan-zamzami",
...
<template>
    ...
    <article data-page="about">
      ...
      >
        <div class="flex justify-center">
          <img
            class="w-9/12 max-w-[500px] h-auto rounded-full object-cover aspect-square mb-3 fadein-up"
            src="/img/Profil.jpg"
            alt="Foto"
          />
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hello everyone! My name is Aden Wildan Zamzami.
            I am an Informatics Engineering student from Bogor, West Java. I am
            currently in my 4th semester, majoring in Informatics Engineering at
            Binaniaga Indonesia University. I really enjoy what I am doing right
            now. In my opinion, programming is not just a job and a learning
            process, but also an art that holds aesthetic value.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I am interested in Web Development, Frontend
            Engineering, Software Engineering, Graphic Design, and similar
            fields. My goal is to convey your message and identity in the most
            creative way. If you are interested in hiring me, and why not expand
            our network as well, feel free to contact me through the listed
            contact information.
          </p>
        </div>
      </section>
  ...
  <div
    class="text-center text-2xl font-bold text-white mb-5 fadein-bot title-section">
    Social Media
    <div
      class="h-[2px] w-16 bg-amber-200 mx-auto mt-2 aos-init aos-animate"
      data-aos="zoom-in-left"
      data-aos-duration="600">
    </div>
  </div>
  ...
  <div class="flex flex-wrap gap-4 mt-5 justify-center">
    <div v-for="social in socialLinks" :key="social.id" class="item-tech">
      <a :href="social.url" target="_blank" class="block">
        <img
          class="w-10 h-10 img-tech"
          :src="social.imageUrl"
          :alt="social.name"
        />
      </a>
