<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Aden Wildan Zamzami</h1>
      <p class="text-amber-200">and I am motivated to become...</p>
      <div class="py-2">
        <h1
    ...
    <img alt="Profil" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-[300px] h-[300px] rounded-full border-4 border-amber-200 object-cover aspect-square pict"
        src="/img/Profil.jpg">
</div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "FrontEnd Engineer", "Informatics Student", "Graphic Designer","UI/UX Designer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
